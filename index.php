...
<html lang="en">
  ...
  <body style="background-color :#00BFFF">
    ...
    <nav class="navbar navbar-expand-md " style="background-color:black">
      <a class="navbar-brand"  style="color :blue;"><b>SPARKS FUND BANK</b></a>
	    ...
	    <div class="container-fluid py-5">
		    <div class="row py-5">
			    <div class = "col-lg-12 col-mg-12 py-5 mr-auto">
			      <marquee behavior="scroll" direction="left" style="color:yellow"><b>Hello Customer, Welcome to Spark Fund Bank<b></marquee>
				    <h4>Welcome to</h4>
				    <h3><b>Spark Fund Bank</b></h3>
				    <marquee behavior="scroll" direction="left" style="color:#808000;">* Click <b>View Customer </b> button to see the customer list</marquee>
				    <marquee behavior="scroll" direction="left" style="color:#808000;">* Click <b>Make a Transaction</b> button to make the transaction</marquee>
				    <marquee behavior="scroll" direction="left" style="color:#808000;">* Click <b>Transaction history</b> to see Transaction history</marquee>
			    </div>
		   </div>
	    </div>
    </header>
    ...
    <footer class="text-center mt-5 py-2" style="background-color:rgb(135,206,250);">
      <p>&copy 2021 Designed by <b>Subramanya K S</b> <br> Spark Fund Bank</p>
    </footer>
  </body>
</html>